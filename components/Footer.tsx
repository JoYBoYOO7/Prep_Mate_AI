  ...
  return (
    <footer className="relative  text-gray-300  ">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <Link href="https://github.com/JoYBoYOO7/Prep_Mate_AI" >
        < Github />
        </Link>
      ...
      <div className="mt-4 px-6 flex flex-col md:flex-row items-center justify-between text-sm text-gray-600">
        ...
        <Link href="https://www.linkedin.com/in/vansh-joy-yadav/" className="hover:underline">LinkedIn</Link>
          <Link href="https://github.com/JoYBoYOO7/" className="hover:underline">GitHub</Link>
          <Link href="mailto:vansh.15926@gmail.com" className="hover:underline">Contact Us</Link>
        </div>
        <div>
        {year && <>Copyright © {year} | <span className="font-semibold">PrepMate</span></>}
        </div>
      </div>
    </footer>
  );
